...
function animate() {
  ...
  orbiters.forEach(o => {
    const a = t * o.sp + o.ph;
    // orbit plane sits behind the mascot so nothing crosses his face
    o.m.position.set(Math.cos(a) * o.r * ps, (o.y + Math.sin(t * 1.6 + o.ph) * 0.18) * ps, (Math.sin(a) * o.r * 0.4 - 1.1) * ps);
...
function injectCss() {
  ...
  #tr-title{position:fixed;inset:0;z-index:20;overflow:hidden;transition:opacity .35s ease;
    background:radial-gradient(120% 90% at 50% 12%,#FFF3DD 0%,#FFE3B8 38%,#FBC98A 70%,#EFA85E 100%);font-family:var(--font-display)}
  ...
  .tt-logo .t{font-size:clamp(52px,16vw,92px);color:#E8442C;-webkit-text-stroke:4px #fff;paint-order:stroke fill}
  .tt-logo .r{font-size:clamp(52px,16vw,92px);color:#FF9E1B;margin-top:-6px;-webkit-text-stroke:4px #8a4209;paint-order:stroke fill}
  .tt-tag{margin-top:12px;font-size:clamp(13px,3.6vw,17px);font-weight:700;color:#9A551F}
  .tt-chips{margin-top:14px;display:flex;gap:10px;flex-wrap:wrap;justify-content:center}
  .tt-best{font-size:14px;font-weight:700;color:#7a4516;background:rgba(255,255,255,.6);border:2px solid rgba(255,255,255,.8);padding:7px 15px;border-radius:999px;backdrop-filter:blur(4px);box-shadow:0 4px 12px rgba(150,90,20,.18)}
  ...
  .tt-lvl{width:48px;height:52px;border:none;border-radius:14px;cursor:pointer;font-family:var(--font-display);font-weight:800;font-size:18px;color:#7a4516;
    background:rgba(255,255,255,.75);border:2px solid rgba(255,255,255,.9);box-shadow:0 4px 10px rgba(150,90,20,.2);display:flex;flex-direction:column;align-items:center;justify-content:center;line-height:1}
  .tt-lvl i{font-style:normal;font-size:9.5px;letter-spacing:1px;color:#F08A1E;margin-top:2px}
  .tt-lvl.cur{background:linear-gradient(180deg,#FFE3A8,#FFD27A);border-color:#F4A03C;color:#8A4209}
  ...
  .tt-ghost{font-weight:700;font-size:14px;color:#7a4516;background:rgba(255,255,255,.65);border:2px solid rgba(255,255,255,.85);padding:10px 18px;border-radius:14px;cursor:pointer;backdrop-filter:blur(4px);box-shadow:0 4px 10px rgba(150,90,20,.16)}
  .tt-ghost:active{transform:translateY(1px)}
  .tt-ver{margin-bottom:10px;font-size:11px;font-weight:600;color:#B0793C;letter-spacing:1px}
